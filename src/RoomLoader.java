...
public class RoomLoader {
    private Map<String, DialogueNode> dialogueMap;

    public RoomLoader(Map<String, DialogueNode> dialogueMap) {
    ...
    public Map<String, Room> loadRooms(String filePath) {
        ...
        try {
            ...
            for (Map.Entry<String, JsonElement> entry : jsonObject.entrySet()) {
                ...
                Room room = new Room(roomId, name, description, exits, items, npcs);
